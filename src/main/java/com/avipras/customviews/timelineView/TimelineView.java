package com.avipras.customviews.timelineView;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_markerSize, dpToPx(20, context));
        ...
        mLineWidth = typedArray.getDimensionPixelSize(R.styleable.TimelineView_timelineWidth, dpToPx(2, getContext()));
