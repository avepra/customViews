...
import kotlinx.android.synthetic.main.custom_loader.view.*

class CustomProgressBar(mContext: Context) {

    var dialog: Dialog = Dialog(mContext, R.style.CustomProgressBarTheme)
    ...
    fun show(context: Context, title: CharSequence?): Dialog {
        ...
        setColorFilter(view.cp_pbar.indeterminateDrawable,
                ResourcesCompat.getColor(context.resources, R.color.colorLightGreenTextColor, null)) //Progress Bar Color
